...
import ph.kodego.aragon.janreign.music_player.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
      lateinit var MusicLisMA : ArrayList<Music>
    }
    ...
    requestRuntimePermission() //to call permission
    setTheme(R.style.coolPinkNav) // change the theme/app background to pink
    ...
    MusicLisMA = getAllAudio()
    binding.musicRV.setHasFixedSize(true)
    binding.musicRV.setItemViewCacheSize(13)
    binding.musicRV.layoutManager = LinearLayoutManager(this@MainActivity)
    musicAdapter = MusicAdapter(this@MainActivity, MusicLisMA)
